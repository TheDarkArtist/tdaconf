...
vim.keymap.set("n", "<leader>V", "<cmd>vsplit<CR>", { noremap = true, silent = true }) -- Vertical split
vim.keymap.set("n", "<leader>S", "<cmd>split<CR>", { noremap = true, silent = true }) -- Horizontal split

-- Remap for navigating between windows
vim.keymap.set("n", "<C-l>h", "<C-w>h", { noremap = true, silent = true }) -- Move to the left window
vim.keymap.set("n", "<C-l>j", "<C-w>j", { noremap = true, silent = true }) -- Move to the bottom window
vim.keymap.set("n", "<C-l>k", "<C-w>k", { noremap = true, silent = true }) -- Move to the top window
vim.keymap.set("n", "<C-l>l", "<C-w>l", { noremap = true, silent = true }) -- Move to the right window

-- Open a new tab and start Nvim-Tree
vim.keymap.set("n", "<A-t>", function()
	vim.cmd("tabnew") -- Open a new tab
	vim.cmd("NvimTreeToggle") -- Start Nvim-Tree in the new tab
